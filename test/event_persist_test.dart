...
import 'package:aptabase_flutter/src/offline_logic/services/sembast.dart';
...
void main() async {
  ...
  test('save and get', () async {
    ...
    await dbStore.add(db.db, EventOffline.dummy2.toMap());
    // Build our app and trigger a frame.
    final recordSnapshot = await dbStore.find(db.db);
    final events =
